          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text('PARAMÈTRES', style: WTText.caps(11)),
              ),
        ...
        children: [
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Mode d\'objectif', style: WTText.label(14)),
                const SizedBox(height: 2),
                Text(
                  isDaily
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          _pill('Jour', isDaily, () => onChanged(true)),
          _pill('Semaine', !isDaily, () => onChanged(false)),
        ],
      ),
    );
  }
        ...
        children: [
          GestureDetector(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  Text('Horaires par jour', style: WTText.label(14)),
                  const Spacer(),
        ...
        children: [
          GestureDetector(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  Text('Pause déjeuner', style: WTText.label(14)),
                  const Spacer(),
                  if (!_expanded)
                    Container(
                      padding: const EdgeInsets.symmetric(
