...
class WorkingTimeApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // French is the primary language — fallback when device locale not supported
...
class _MainShellState extends State<_MainShell> {
  ...
  Widget build(BuildContext context) {
    ...
    final tabs = [
      _TabItem(icon: _tabIcons[0], label: l.tabHome),
      _TabItem(icon: _tabIcons[1], label: l.tabWeek),
      _TabItem(icon: _tabIcons[2], label: l.tabHistory),
    ];
