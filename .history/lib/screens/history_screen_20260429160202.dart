              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(_weekRange(context), style: WTText.label(14)),
...
class _SessionRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final departure = session.departureTime != null
        ...
        : '--:--';
    final locale = Localizations.localeOf(context).toLanguageTag();
    final dayLabel = DateFormat('EEE d MMM', locale).format(session.arrivalTime);
              ...
              children: [
                ...
                if (session.pauses.isNotEmpty &&
                  ...
                  Container(
                    ...
                    child: Text(
                      AppLocalizations.of(context)!.historyPauses(session.pauses.length),
